// GENERATED by data/processors/story-the-lights-came-on.mjs — do not edit by hand; regenerate via pnpm data:build
...
export const YEARS : YearPoint[] = [
    ...
    { y : 2020,  acc : 221554464,    accM : 143171703,    accF : 78382761,     out : 4101790,  outM : 3194483,  outF : 907307,   faV : 26 },
...
export const BOOK_MIX : BookMixPoint[] = [
    { y : 2015, pl : 16.5 , oi : 14.3 , pc : 40   , rest : 29.2 },
    ...
    { y : 2021, pl : 26.2 , oi : 16   , pc : 28.3 , rest : 29.5 },
    { y : 2022, pl : 27.6 , oi : 16.1 , pc : 26.8 , rest : 29.5 },
    { y : 2023, pl : 28.5 , oi : 16   , pc : 25.9 , rest : 29.6 },
    { y : 2024, pl : 30.7 , oi : 15.5 , pc : 26   , rest : 27.7 },
...
export const WOMEN_BY_SECTOR : SlopeRow[] = [
    { name : "Agriculture"          , y2015 : 20.3 , y2026 : 33 },
    { name : "Trade"                , y2015 : 12.6 , y2026 : 26.7 },
    { name : "Personal loans"       , y2015 : 18   , y2026 : 23 },
    { name : "Industry"             , y2015 : 14.8 , y2026 : 19.8 },
    { name : "All others"           , y2015 : 17   , y2026 : 19.5 },
