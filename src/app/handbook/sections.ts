// The sections of the Handbook of statistics page, in the order it lists them: each names the curated pages under it.
...
export const HANDBOOK_SECTIONS : ListSection[] = [
    {
