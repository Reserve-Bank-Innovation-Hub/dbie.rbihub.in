...
// LOCAL COMPONENTS ====================================================================================================
import BopBpm6InrGrid from "@/components/tables/BopBpm6InrGrid";
...
const BopBpm6InrPage : React.FC<BopBpm6InrPageProps> = ({ data }) => {
    ...
    const fmtNet = (v : number | null) =>
        v == null ? "—" : `₹${Math.abs(v).toLocaleString("en-IN", { maximumFractionDigits : 0 })} cr.`;

    return (
        <Article id="bop-bpm6-inr-page" className="page-grid">
            {/* HEADER ///////////////////////////////////////////////////////////////////////////////////////////// */}
            <Div id="title-card" className="grid-cell" padding="micro">
                <Div>
                    <Heading4 weight="700" marginBottom="nano">
                        Balance of payments — BPM6 standard presentation (₹ crore)
                    </Heading4>
