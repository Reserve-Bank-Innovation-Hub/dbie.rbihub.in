...
// LIB =================================================================================================================
import { NetStateValueAddedAtCurrentPrices } from "@/lib/api/tables/net-state-value-added-by-economic-activity-at-current-prices";
...
// STYLES ==============================================================================================================
import "./nsva-at-current-prices-page.css";

// Dynamic import to avoid SSR issues with Plotly
const Plot = dynamic(() => import("react-plotly.js"), { ssr : false });

interface NsvaAtCurrentPricesPageProps {
...
const NsvaAtCurrentPricesPage : React.FC<NsvaAtCurrentPricesPageProps> = ({ data }) => {
    ...
    const chart = useMemo(() => {
        ...
        const traces : Partial<Plotly.PlotData>[] = [
            {
                ...
                marker        : { color : CHART_COLORS.blueDark, size : 6 },
        ...
        const layout : Partial<Plotly.Layout> = getBaseLayout({
            ...
            yaxis : createAxis("₹ crores (current prices)"),
        });

        const config : Partial<Plotly.Config> = getBaseConfig(
            `nsva_current_${selectedState.name.toLowerCase().replace(/\s+/g, "_")}`,
        );
    ...
    return (
        <Article id="nsva-at-current-prices-page" className="page-grid">
            {/* HEADER ///////////////////////////////////////////////////////////////////////////////////////////// */}
            ...
            {/* CHART ////////////////////////////////////////////////////////////////////////////////////////////// */}
            <Div className="nsva-at-current-prices-linechart">
                {chart ? (
                    <Plot
                        data={chart.traces}
                        layout={chart.layout}
            ...
            {/* DATA GRID ////////////////////////////////////////////////////////////////////////////////////////// */}
            <Div className="nsva-at-current-prices-grid">
                <NsvaAtCurrentPricesGrid
                    data={data}
...
export default NsvaAtCurrentPricesPage;
