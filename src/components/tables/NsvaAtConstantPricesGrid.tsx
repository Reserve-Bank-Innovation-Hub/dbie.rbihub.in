...
// LIB =================================================================================================================
import { NetStateValueAddedAtConstantPrices, NsvaStateEntry } from "@/lib/api/tables/net-state-value-added-by-economic-activity-at-constant-prices";
...
interface NsvaAtConstantPricesGridProps {
...
const NsvaAtConstantPricesGrid : React.FC<NsvaAtConstantPricesGridProps> = ({ data, selectedState }) => {
    ...
    return (
        <div className="nsva-at-constant-prices-grid-wrapper">
            <AgGridReact
                rowData={rowData}
...
export default NsvaAtConstantPricesGrid;
