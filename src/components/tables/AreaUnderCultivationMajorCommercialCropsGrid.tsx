...
interface AreaUnderCultivationMajorCommercialCropsGridProps {
    data  : AreaUnderCultivationMajorCommercialCropsRow[];
    units : string;
}

const AreaUnderCultivationMajorCommercialCropsGrid : React.FC<AreaUnderCultivationMajorCommercialCropsGridProps> = ({ data, units }) => {
    ...
    return (
        <div className="area-under-cultivation-major-commercial-crops-grid-wrapper">
            <AgGridReact
                rowData={data}
...
export default AreaUnderCultivationMajorCommercialCropsGrid;
