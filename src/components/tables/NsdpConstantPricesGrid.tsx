...
interface NsdpConstantPricesGridProps {
    data : NsdpConstantPrices;
}
...
const NsdpConstantPricesGrid : React.FC<NsdpConstantPricesGridProps> = ({ data }) => {
    ...
    return (
        <Div className="nsdp-constant-prices-grid-wrapper" style={{ display : "flex", flexDirection : "column", flex : 1 }}>
            <div style={{ flex : 1 }}>
                <AgGridReact
                    rowData={rowData}
...
export default NsdpConstantPricesGrid;
