...
// LIB =================================================================================================================
import {
    MacroEconomicAggregatesCurrentPricesRow,
} from "@/lib/api/tables/macro-economic-aggregates-at-current-prices";
...
interface MacroEconomicAggregatesCurrentPricesGridProps {
    data : MacroEconomicAggregatesCurrentPricesRow[];
}

const MacroEconomicAggregatesCurrentPricesGrid : React.FC<MacroEconomicAggregatesCurrentPricesGridProps> = ({ data }) => {
    ...
    const columnDefs = useMemo<ColDef[]>(() => {
        ...
        return [
            ...
            numCol("population_lakhs",                 "Population (lakhs)"),
            ...
            numCol("gross_national_disposable_income",  "Gross national disposable income (₹ cr)"),
            numCol("gross_saving",                      "Gross saving (₹ cr)"),
    ...
    return (
        <div className="macro-economic-aggregates-current-prices-grid-wrapper">
            <AgGridReact
                rowData={data}
...
export default MacroEconomicAggregatesCurrentPricesGrid;
