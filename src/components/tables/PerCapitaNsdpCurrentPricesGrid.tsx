...
interface PerCapitaNsdpCurrentPricesGridProps {
    data : PerCapitaNsdpCurrentPrices;
}
...
const PerCapitaNsdpCurrentPricesGrid : React.FC<PerCapitaNsdpCurrentPricesGridProps> = ({ data }) => {
    ...
    return (
        <Div className="per-capita-nsdp-current-prices-grid-wrapper" style={{ display : "flex", flexDirection : "column", flex : 1 }}>
            <div style={{ flex : 1 }}>
                <AgGridReact
                    rowData={rowData}
...
export default PerCapitaNsdpCurrentPricesGrid;
