...
interface AreaUnderCultivationFoodgrainsGridProps {
    data  : AreaUnderCultivationFoodgrainsRow[];
    units : string;
}

const AreaUnderCultivationFoodgrainsGrid : React.FC<AreaUnderCultivationFoodgrainsGridProps> = ({ data, units }) => {
    ...
    return (
        <div className="area-under-cultivation-foodgrains-grid-wrapper">
            <AgGridReact
                rowData={data}
...
export default AreaUnderCultivationFoodgrainsGrid;
