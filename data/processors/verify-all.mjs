...
const datasets = [
  { name: 'agricultural-production-foodgrains', mode: 'fresh' },
  { name: 'agricultural-production-major-commercial-crops', mode: 'fresh' },
  ...
  { name: 'area-under-cultivation-foodgrains', mode: 'fresh' },
  { name: 'area-under-cultivation-major-commercial-crops', mode: 'fresh' },
  { name: 'average-price-of-gold-and-silver-in-domestic-and-foreign-markets', mode: 'fresh' },
  ...
  { name: 'changes-in-financial-assets-liabilities-of-the-household-sector', mode: 'fresh' },
  { name: 'combined-receipts-disbursements', mode: 'fresh' },
  { name: 'commercial-bank-survey', mode: 'fresh' },
  { name: 'commercial-paper', mode: 'fresh' },
  { name: 'components-of-gross-domestic-product', mode: 'exact' },
  { name: 'components-of-gross-value-added-at-basic-prices', mode: 'fresh' },
  { name: 'consumer-price-index', mode: 'fresh' },
  ...
  { name: 'dated-securities-ownership', mode: 'fresh' },
  { name: 'employment-in-public-and-organised-private-sectors', mode: 'fresh' },
  { name: 'exchange-rates', mode: 'fresh' },
  { name: 'external-commercial-borrowings', mode: 'fresh' },
  ...
  { name: 'forex-reserves-weekly', mode: 'fresh' },
  ...
  { name: 'index-numbers-of-agricultural-production-major-crops', mode: 'fresh' },
  { name: 'index-numbers-of-area-production-and-yield-of-foodgrains-non-foodgrains', mode: 'fresh' },
  ...
  { name: 'index-numbers-of-infrastructure-industries', mode: 'fresh' },
  ...
  { name: 'institutional-sector-wise-gross-capital-formation-at-current-prices', mode: 'fresh' },
  ...
  { name: 'minimum-support-price-for-foodgrains-according-to-crop-year-fair-average', mode: 'fresh' },
  { name: 'minimum-support-price-for-non-foodgrains-according-to-crop-year-fair', mode: 'fresh' },
  { name: 'monetary-survey', mode: 'exact' },
  { name: 'money-stock-measures', mode: 'fresh' },
  ...
  { name: 'new-capital-issues', mode: 'fresh' },
  { name: 'nri-deposits', mode: 'exact' },
  { name: 'other-consumer-price-indices', mode: 'exact' },
  { name: 'outward-remittances-lrs', mode: 'exact' },
  { name: 'pattern-of-land-use-and-select-inputs-for-agricultural-production', mode: 'fresh' },
  { name: 'payment-system-indicators', mode: 'fresh' },
  ...
  { name: 'rbi-liabilities-and-assets', mode: 'fresh' },
  { name: 'rbi-standing-facilities', mode: 'exact' },
  { name: 'rbi-survey', mode: 'exact' },
  { name: 'reer-and-neer', mode: 'fresh' },
  { name: 'reserve-money', mode: 'exact' },
  { name: 'scb-investments', mode: 'exact' },
  { name: 'sdmx-agricultural-statistics-indian-state', mode: 'exact' },
  { name: 'sdmx-average-forex-rate', mode: 'exact' },
  { name: 'sdmx-exchange-rate-of-the-indian-rupee-daily', mode: 'exact' },
  { name: 'sdmx-series-index', mode: 'exact' },
  { name: 'sector-wise-cost-overrun-of-delayed-central-sector-projects-end-march', mode: 'exact' },
  { name: 'sector-wise-domestic-savings-at-current-prices', mode: 'fresh' },
  { name: 'select-economic-indicators', mode: 'fresh' },
  { name: 'small-savings', mode: 'fresh' },
  { name: 'sources-of-money-stock', mode: 'fresh' },
  ...
  { name: 'yield-per-hectare-foodgrains', mode: 'fresh' },
  { name: 'yield-per-hectare-major-commercial-crops', mode: 'fresh' },
];
